 ...
 */
#if defined(FMPI2C1)
#define IS_LL_RCC_FMPI2C_CLKSOURCE(__VALUE__)                                  \
  ((__VALUE__) == LL_RCC_FMPI2C1_CLKSOURCE)
#endif /* FMPI2C1 */
...
#if defined(SDIO)
#define IS_LL_RCC_SDIO_CLKSOURCE(__VALUE__)                                    \
  (((__VALUE__) == LL_RCC_SDIO_CLKSOURCE))
#endif /* SDIO */
...
#define IS_LL_RCC_SPDIFRX_CLKSOURCE(__VALUE__)                                 \
  (((__VALUE__) == LL_RCC_SPDIFRX1_CLKSOURCE))
#endif /* SPDIFRX */
/**
 * @}
 */
...
uint32_t LL_RCC_GetSAIClockFreq(uint32_t SAIxSource) {
  ...
  if ((SAIxSource == LL_RCC_SAI1_CLKSOURCE) ||
      (SAIxSource == LL_RCC_SAI2_CLKSOURCE)) {
  ...
  if ((SAIxSource == LL_RCC_SAI1_A_CLKSOURCE) ||
      (SAIxSource == LL_RCC_SAI1_B_CLKSOURCE)) {
    /* SAI1CLK clock frequency */
    switch (LL_RCC_GetSAIClockSource(SAIxSource)) {
#if defined(RCC_PLLSAI_SUPPORT)
    case LL_RCC_SAI1_A_CLKSOURCE_PLLSAI: /* PLLSAI clock used as SAI1 Block A
                                            clock source */
    case LL_RCC_SAI1_B_CLKSOURCE_PLLSAI: /* PLLSAI clock used as SAI1 Block B
                                            clock source */
      if (LL_RCC_PLLSAI_IsReady()) {
        sai_frequency = RCC_PLLSAI_GetFreqDomain_SAI();
      }
    ...
    case LL_RCC_SAI1_A_CLKSOURCE_PLLI2S: /* PLLI2S clock used as SAI1 Block A
                                            clock source */
    case LL_RCC_SAI1_B_CLKSOURCE_PLLI2S: /* PLLI2S clock used as SAI1 Block B
                                            clock source */
      if (LL_RCC_PLLI2S_IsReady()) {
        sai_frequency = RCC_PLLI2S_GetFreqDomain_SAI();
      }
    ...
    case LL_RCC_SAI1_A_CLKSOURCE_PLL: /* PLL clock used as SAI1 Block A clock
                                         source */
    case LL_RCC_SAI1_B_CLKSOURCE_PLL: /* PLL clock used as SAI1 Block B clock
                                         source */
      if (LL_RCC_PLL_IsReady()) {
        sai_frequency = RCC_PLL_GetFreqDomain_SAI();
      }
    ...
    case LL_RCC_SAI1_B_CLKSOURCE_PLLSRC:
      switch (LL_RCC_PLL_GetMainSource()) {
      case LL_RCC_PLLSOURCE_HSE: /* HSE clock used as SAI1 Block A or B clock
                                    source */
        if (LL_RCC_HSE_IsReady()) {
          sai_frequency = HSE_VALUE;
        }
      ...
      case LL_RCC_PLLSOURCE_HSI: /* HSI clock used as SAI1 Block A or B clock
                                    source */
      default:
        if (LL_RCC_HSI_IsReady()) {
          sai_frequency = HSI_VALUE;
    ...
    case LL_RCC_SAI1_A_CLKSOURCE_PIN: /* External input clock used as SAI1 Block
                                         A clock source */
    case LL_RCC_SAI1_B_CLKSOURCE_PIN: /* External input clock used as SAI1 Block
                                         B clock source */
    default:
      sai_frequency = EXTERNAL_CLOCK_VALUE;
      break;
...
uint32_t LL_RCC_GetSDIOClockFreq(uint32_t SDIOxSource) {
  ...
  if (SDIOxSource == LL_RCC_SDIO_CLKSOURCE) {
    ...
    case LL_RCC_SDIO_CLKSOURCE_PLL48CLK: /* PLL48M clock used as SDIO clock
                                            source */
...
#if defined(RCC_PLLSAI_SUPPORT)
      case LL_RCC_CK48M_CLKSOURCE_PLLSAI: /* PLLSAI clock used as 48Mhz domain
                                             clock */
      default:
        if (LL_RCC_PLLSAI_IsReady()) {
...
#if defined(RCC_PLLI2SCFGR_PLLI2SQ) && !defined(RCC_DCKCFGR_PLLI2SDIVQ)
      case LL_RCC_CK48M_CLKSOURCE_PLLI2S: /* PLLI2S clock used as 48Mhz domain
                                             clock */
      default:
        if (LL_RCC_PLLI2S_IsReady()) {
...
uint32_t RCC_PLL_GetFreqDomain_SPDIFRX(void) {
  ...
  */
  ...
  return __LL_RCC_CALC_PLLCLK_SPDIFRX_FREQ(
...
uint32_t RCC_PLL_GetFreqDomain_SAI(void) {
  ...
  */
  ...
  plloutputfreq = __LL_RCC_CALC_PLLCLK_SAI_FREQ(
      pllinputfreq, LL_RCC_PLL_GetDivider(), LL_RCC_PLL_GetN(),
      LL_RCC_PLL_GetR(), LL_RCC_PLL_GetDIVR());
#else
  plloutputfreq =
      __LL_RCC_CALC_PLLCLK_SAI_FREQ(pllinputfreq, LL_RCC_PLL_GetDivider(),
                                    LL_RCC_PLL_GetN(), LL_RCC_PLL_GetR());
...
uint32_t RCC_PLLSAI_GetFreqDomain_SAI(void) {
  ...
  */
  ...
  return __LL_RCC_CALC_PLLSAI_SAI_FREQ(
      pllinputfreq, LL_RCC_PLLSAI_GetDivider(), LL_RCC_PLLSAI_GetN(),
...
uint32_t RCC_PLLSAI_GetFreqDomain_LTDC(void) {
  ...
  */
  ...
  return __LL_RCC_CALC_PLLSAI_LTDC_FREQ(
      pllinputfreq, LL_RCC_PLLSAI_GetDivider(), LL_RCC_PLLSAI_GetN(),
...
uint32_t RCC_PLLI2S_GetFreqDomain_SAI(void) {
  ...
  */
  ...
  case LL_RCC_PLLI2SSOURCE_PIN: /* External pin input clock used as PLLI2S clock
                                   source */
  ...
  plli2soutputfreq = __LL_RCC_CALC_PLLI2S_SAI_FREQ(
      plli2sinputfreq, LL_RCC_PLLI2S_GetDivider(), LL_RCC_PLLI2S_GetN(),
...
uint32_t RCC_PLLI2S_GetFreqDomain_SPDIFRX(void) {
  ...
  */
  ...
  return __LL_RCC_CALC_PLLI2S_SPDIFRX_FREQ(
      pllinputfreq, LL_RCC_PLLI2S_GetDivider(), LL_RCC_PLLI2S_GetN(),
      LL_RCC_PLLI2S_GetP());
}
#endif /* SPDIFRX */
...
uint32_t RCC_PLLI2S_GetFreqDomain_I2S(void) {
  ...
  */
  ...
  plli2soutputfreq =
      __LL_RCC_CALC_PLLI2S_I2S_FREQ(plli2sinputfreq, LL_RCC_PLLI2S_GetDivider(),
...
uint32_t RCC_PLLI2S_GetFreqDomain_48M(void) {
  ...
  */
  ...
  plli2soutputfreq =
      __LL_RCC_CALC_PLLI2S_48M_FREQ(plli2sinputfreq, LL_RCC_PLLI2S_GetDivider(),
