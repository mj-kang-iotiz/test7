 ...
 * when the USART is disabled (USART_CR1_UE bit =0), USART IP should be in
...
ErrorStatus LL_USART_Init(USART_TypeDef *USARTx,
  ...
  if (LL_USART_IsEnabled(USARTx) == 0U) {
     ...
     * ----------------------- Configure USARTx CR1 (USART Word Length, Parity,
     * Mode and Oversampling bits) with parameters:
